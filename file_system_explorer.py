...
if __name__ == "__main__": #main run function
    ...
    while True: #main running loop
        ...
        if command == "mf":
            ...
            for c, e in [('mf', 'Create a file, takes name argument'), ('copy', 'Copy a file or directory, takes name argument'), ('paste', 'Paste the last copied file or directory into current working directory'), ('mv', 'Move a file or directory, takes a location/name argument of file in new location'), ('edit', 'Edit the contents of a file, takes name argument'), ('mdir', 'Create a dir, takes name argument'), ('delf', 'Delete a file, takes name argument'), ('deld', 'Delete a directory, takes name argument'), ('cat', 'Read contents of a file, takes name argument'), ('cd', 'Change working directory, takes name argument OR / to return to root OR .. to go to parent directory'), ('ls', 'List current working directory contents'), ('load', 'Load the file system from the last saved session'), ('undo', 'Undo your last action'), ('exit', 'Exit the system'), ('help', 'See this page')]:
                print(c + " | " + e)
        else:
